        ...
        <div className="mb-6 bg-white/90 backdrop-blur-md border border-gray-200 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                ...
                <div className="flex flex-col sm:flex-row justify-between sm:items-start gap-3">
                    <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="inline-block px-3 py-1 text-xs rounded-full bg-purple-50 text-purple-700 font-medium">
                                Long Answer
                            </span>
                        </div>
                    ...
                    <div className="flex flex-row sm:flex-col gap-2">
                        <span className="px-3 py-1 font-medium text-xs text-center bg-purple-50 text-purple-700 rounded-full flex items-center">
            ...
            <div className="p-5">
                    ...
                    <div className="p-4 rounded-lg border border-gray-200 bg-gray-50">
                        ...
                        {answerText.length > 250 && (
                            <button
                                ...
                                className="mt-3 px-4 py-2 text-sm bg-white border border-gray-200 text-blue-600 hover:bg-blue-50 rounded-full shadow-sm transition-colors flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
                            >
                ...
                {(question.marking_scheme && question.marking_scheme.length > 0) ? (
                    <div className="mt-5 pt-4 border-t border-gray-100">
                        <div className="flex items-start gap-3">
                            <ListChecks className="w-5 h-5 text-purple-600 mt-0.5 flex-shrink-0" />
                            <div>
                                <h4 className="font-medium text-gray-800 mb-2">
                                    Marking Scheme
                                </h4>
                                <ul className="text-gray-700 space-y-2 bg-purple-50/50 p-4 rounded-lg border border-purple-100">
                                    {question.marking_scheme.map((point, i) => (
                                        <li key={i} className="flex items-start">
                                            <div className="w-5 h-5 bg-purple-100 text-purple-700 rounded-full flex items-center justify-center text-xs font-bold mr-2 mt-0.5 flex-shrink-0">
                                                {i+1}
                                            </div>
                                            <span>{point}</span>
                                        </li>
