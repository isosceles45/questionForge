...
print(graph_func.query("Is this question present in PYQs? if yes, when? Question:{question} 'Explore Upper-Confidence-Bound (UCB) Action Selection in multi-armed bandits. Analyze UCB's formula and address potential application challenges.'", param=QueryParam(mode="local")))