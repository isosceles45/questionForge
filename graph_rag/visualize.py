...
def visualize_graphml(graphml_file, html_path, port=8000):
    ...
    # Only create directory if html_dir is not empty
    if html_dir and not os.path.exists(html_dir):
        os.makedirs(html_dir)
    json_path = os.path.join(os.path.dirname(html_path), 'graph_json.js')
...
if __name__ == "__main__":
    graphml_file = "Graph/graph_chunk_entity_relation.graphml"  # replace with your GraphML file path
